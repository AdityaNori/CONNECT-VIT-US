<?php
	...
	if(isset($_SESSION['tempfbuser']))
	{
		...
		if($count1==0)
		{
		    $sql3="select * from user_profile_pic where user_id='$userid'";
...
<?php
	if(isset($_POST['Next']))
	{
		$que1=$_POST['que'];
		$ans1=$_POST['ans'];
        $sql4="insert into user_secret_quotes(user_id,Question1,Answer1,Question2,Answer2) values ('$userid','$que1','$ans1',0,0)";
