<?php
	...
	if(isset($_SESSION['tempfbuser']))
	{
		...
		$userid=$rec[0];
		$sql2="select * from user_secret_quotes where user_id='$userid'";
...
<?php
	if(isset($_POST['Finish']))
	{
		$que2=$_POST['que'];
		$ans2=$_POST['ans'];
		$sql4="update user_secret_quotes set Question2='$que2',Answer2='$ans2' where user_id='$userid'";
		$que4=mysqli_query($con,$sql4);
		$sql5="select * from users where Email='$user'";
		$que_user_data=mysqli_query($con,$sql5);
